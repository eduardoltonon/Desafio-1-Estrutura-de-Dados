...
- **Gerenciamento de Memória Seguro:** Utilização rigorosa de `malloc` e `free` para a alocação dinâmica de cada nó da fila, evitando _memory leaks_ (vazamento de memória).
